    ...
    <>
      ...
      >
        ...
        <div className="absolute z-40 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <p data-aos="fade-down" className="text-yellow text-4xl text-center font-semibold">January 20 , 2023</p>
          <h2 data-aos="fade-down" className="text-white text-7xl text-center mt-8 font-bold">Word Digital </h2>
          <h2 data-aos="fade-up" className="text-white text-7xl text-center mt-2 font-bold">Conference 2023 </h2>
